...
public class ScheduleJobService {
    ...
    private void addJob(ScheduleJob scheduleJob) throws Exception {
        ...
        JobDetail jobDetail = JobBuilder.newJob((Class<? extends Job>) Class.forName(scheduleJob.getJobName())).withIdentity(scheduleJob.getJobName(), scheduleJob.getJobGroup()).build();
